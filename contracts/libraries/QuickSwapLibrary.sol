...
library QuickSwapLibrary {
            ...
            uint256(
                keccak256(
                    abi.encodePacked(
                        ...
                        hex'3d24e0acf9f8cbc1c76e7ff2f8e50c0f54c840a16cf6230ad5819d4e35588543' // init code hash
                    )
                )
            )
        );
    ...
    function getReserves(
        ...
        (uint256 reserve0, uint256 reserve1, ) = IQuickSwapPair(pairFor(factory, tokenA, tokenB)).getReserves();
